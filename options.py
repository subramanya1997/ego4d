...
def read_command_line():
    ...
    parser.add_argument("--task", type=str, default="nlq_official_v1", help="target task")
    parser.add_argument(
        "--eval_gt_json",
        type=str,
        default="/work/snagabhushan_umass_edu/dataset/v1/annotations/nlq_val.json",
        help="Provide GT JSON to evaluate while training"
    )
    parser.add_argument(
        "--fv", type=str, default="official", help="[new | org] for visual features"
    )
    parser.add_argument(
        "--max_pos_len",
        type=int,
